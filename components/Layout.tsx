  ...
  return (
    <GridBackground className={cn('transition-colors duration-300 ease-in-out font-sans', getBackground())}>
      ...
      <aside className={cn(
        ...
        {/* Thin divider */}
        <div className={cn("mx-6 mb-4 h-px", theme === 'light' ? 'bg-slate-100' : theme === 'ocean' ? 'bg-blue-800/40' : 'bg-slate-700/50')} />
        ...
        <div className="px-4 mb-3">
          <button
            ...
            className={cn(
              ...
              theme === 'light'
                ...
                : theme === 'ocean'
                ? 'bg-blue-900/30 border-blue-800/40 text-slate-500 hover:text-slate-300'
          ...
          >
            ...
            <span className={cn('hidden md:flex items-center gap-0.5 text-[10px] font-mono opacity-60')}>
              <Command size={10} />K
            </span>
          </button>
        </div>
